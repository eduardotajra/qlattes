    ...
    <Card className="shadow mt-3">
      <CardHeader className="bg-transparent" style={{ flexDirection: 'row', display: 'flex', justifyContent: "space-between" }}>
        ...
        <div>
          ...
          <i className="fas fa-file-export mr-2" onClick={toggleModalAreaSelect} style={{fontSize: "14px", cursor: "pointer"}} hidden={authors < 1} title="Exportar dados dos CVs do grupo"/>
